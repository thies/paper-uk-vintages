...
\hypersetup{unicode=true,
            pdftitle={Machine Learning, Building Styles and Property Values},
...
\setlength{\droptitle}{-2em}
  ...
  \title{Machine Learning, Building Styles and Property Values}
...
\hypertarget{building-style-and-property-price}{%
\subsection{Building style and property
price}\label{building-style-and-property-price}}
...
\((\mathbf{StyleNeigh})\). The intercept is denoted by \(\alpha\) while
...
to multiple groups of households with distinct style preferences?
...
classified by trained architects into the seven styles will serve as
